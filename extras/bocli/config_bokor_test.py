...
@date 2014
@brief bocli configuration for local test
"""
...
DEFAULTS = {'create_download': {'address_torrent': "config.base_url + 'torrents/' + hash_file + '.torrent'",
                                'relative_path': "'test'"},
            'add_file': {'token_file': "'bb77dec688'",
                         'tracker_url': "config.server + ':4242'"}}
DUPLICATE = {}
